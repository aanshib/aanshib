...
I’m a Computer Science student focused on developing real-world solutions by combining
🌐 full-stack development with 🤖 AI/ML capabilities.

💻 Crafting dynamic web apps using MERN Stack
🧠 Building intelligent systems with Python, ML & OpenCV
📊 Strengthening problem-solving through Data Structures & Algorithms
🤝 Core contributor & guiding member of ACM Website Team
⚡ Thrive in collaborative, fast-paced development environments
🌟 Featured Work
...
🔹 Luna – Skincare Assistant

Personalized skincare recommendation system using intelligent analysis

🔹 Kolam (Smart India Hackathon Project)

Developed as part of SIH, focused on solving real-world problem statements through tech innovation
